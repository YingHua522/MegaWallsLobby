...
public class Mole extends Classes {
    public Mole() {
        super("Mole", "鼹鼠", ChatColor.YELLOW, Material.GOLD_SPADE, (byte) 0, ClassesType.MYTHIC, new Orientation[]{Orientation.AGILITY, Orientation.CONTROL}, Difficulty.THREE);
            ...
            public List<ItemStack> getEquipments(int level) {
                ...
                switch (level) {
                    ...
                    case 5: {
                        ...
                        items.add(new ItemBuilder(Material.APPLE, 5).setDisplayName(Mole.this.nameColor + "Junk Apple").addEnchantment(Enchantment.DURABILITY, 10).build());
                        items.add(new ItemBuilder(Material.PUMPKIN_PIE, 40).setDisplayName(Mole.this.nameColor + "Junk Pie").addEnchantment(Enchantment.DURABILITY, 10).build());
                        items.add(new ItemBuilder(Material.POTION, 2, (byte) 5).setDisplayName(Mole.this.nameColor + Mole.this.getDisplayName() + " Potion of Heal (8\u2764)").addPotion(new PotionEffect(PotionEffectType.HEAL, 1, 2)).build());
