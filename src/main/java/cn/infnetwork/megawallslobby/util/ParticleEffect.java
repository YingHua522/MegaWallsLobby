...
import cn.infnetwork.megawallslobby.util.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
    ...
    BLOCK_CRACK("blockcrack", 37, -1, new ParticleEffect.ParticleProperty[]{ParticleEffect.ParticleProperty.REQUIRES_DATA}),
        ...
        public static void initialize() throws ParticleEffect.ParticlePacket.VersionIncompatibleException {
            if (!initialized) {
                try {
                    ...
                    sendPacket = ReflectionUtils.getMethod(playerConnection.getType(), "sendPacket", new Class[]{PackageType.MINECRAFT_SERVER.getClass("Packet")});
                ...
                try {
                    ...
                    if (version < 8) {
                        ...
                        if (this.data != null) {
                            ...
                            ReflectionUtils.setValue(this.packet, true, "k", new int[]{this.effect == ParticleEffect.ITEM_CRACK ? packetData[0] : packetData[0] | packetData[1] << 12});
                        }
                    }
